                            ...
                            for (int i = 0; exeLista.size() > i && aptoLista.size() > i; i++) {
                                ...
                                for (int j = 0; j < exeLista.size(); j++) {
                                    ...
                                    if (exeLista.get(j).ID == 0) {
                                        ExeProcessoLista.set(j, new Processo(p.ID, p.exe,
                                                p.deadline, p.prior, nowTime));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(FinalizadoPai, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
